...
import { FaPhone, FaEnvelope, FaStickyNote, FaRegPaperPlane, FaCopy, FaPencilAlt } from "react-icons/fa";
...
const EmployeeViewLead = () => {
  ...
  // Handle saving updated lead information
            ...
            <div className="col-span-12 lg:col-span-5 bg-white rounded-md shadow-md p-6">
              ...
              <div className="space-y-4 mt-4">
                {notes && notes.length > 0 ? (
                  notes.map((note) => (
                    <div key={note._id} className="bg-gray-100 p-4 rounded-md shadow-sm">
...
export default EmployeeViewLead;