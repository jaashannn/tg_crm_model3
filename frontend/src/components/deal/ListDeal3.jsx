...
// Deal stages
const DEAL_STAGES = [
  { id: 'demoScheduled', name: 'Demo Scheduled' },
  { id: 'demoDone', name: 'Demo Done' },
  { id: 'poc', name: 'POC' },
  { id: 'opportunity', name: 'Opportunity' },
  { id: 'negotiation', name: 'Negotiation' },
  { id: 'closedWon', name: 'Closed Won' },
  { id: 'closedLost', name: 'Closed Lost' },
...
const Deal = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    stage: 'demoScheduled', // Default stage
  });
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif', maxWidth: '1200px', margin: 'auto' }}>
          ...
          {accounts.map((account) => (
            ...
            >
              ...
              <div style={{ display: 'flex', gap: '10px' }}>
                ...
                <button
                  onClick={() => {
                    navigation.navigate(`/admin-dashboard/deals/${account._id}`);
                    setSelectedAccount(account);
      ...
      {selectedAccount && (
        <div style={{ marginTop: '40px', overflowX: 'auto', whiteSpace: 'nowrap' }}>
          <div style={{ display: 'flex', gap: '20px', paddingBottom: '20px' }}>
            {DEAL_STAGES.map((stage) => {
              const stageDeals = deals.filter((deal) => deal.stage === stage.id);
              const totalWeightage = stageDeals.reduce((sum, deal) => sum + (deal.weightage || 0), 0);
              ...
              return (
                ...
                >
                  <h3 style={{ padding: '15px', borderBottom: '1px solid #e0e0e0', fontSize: '18px', fontWeight: '600', color: '#333' }}>
                  ...
                  <div style={{ padding: '15px', borderTop: '1px solid #e0e0e0', fontSize: '14px', fontWeight: '500', color: '#555' }}>
                    <p>Total Deals: {stageDeals.length}</p>
